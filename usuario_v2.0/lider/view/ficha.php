                ...
                <form class="form-horizontal" action="?url=controller/lider_controller.php" method="post" id="frm-solicita">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input id="name" name="txtnome" type="text" placeholder="Nome ex: Márcio Santos" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input id="rg" name="rg" type="text" placeholder="Seu RG ex: 22.222.222-2" class="form-control" maxlength="12" onKeyPress="formatar('##.###.###-#',this)">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select id="usuario" name="usuario" class="form-control">
                                    ...
                                    <option value="Usuário-Criar">Usuário-Criar</option>
                                    <option value="Usuário-Bloquear">Usuário-Bloquear</option>
                                    <option value="Usuário-Desbloquear">Usuário-Desbloquear</option>
                                    <option value="Usuário-Reset-Senha">Usuário-Reset-Senha</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="data_frm" value="<? echo "{$dd}-{$mm}-{$aa}"; ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="lider" placeholder="Seu(a) Líder ex: 'José'">
                            </div>
                        </div>
